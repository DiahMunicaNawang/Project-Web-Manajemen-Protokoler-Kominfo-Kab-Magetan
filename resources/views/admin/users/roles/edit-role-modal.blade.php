<x-molecules.modal id="edit-role-modal" title="Edit role" type="edit" formId="edit-role-list-form" formMethod="POST"
    confirmButton="Konfirmasi" buttonId="edit-button">

    <x-molecules.input label="Role Name" id="edit-name" name="name" type="text" placeholder="Enter a role name"
        required />
                                    ...
                                    @foreach (['create', 'read', 'update', 'delete'] as $action)
                                        <label
                                            ...
                                            <input class="form-check-input ability-checkbox-edit" type="checkbox"
                                                value="{{ $ability . '-' . $action }}" id="edit-permission" name="permission[]">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const selectAllCheckbox = document.getElementById('kt_roles_select_all-edit');
            const abilityCheckboxes = document.querySelectorAll('.ability-checkbox-edit');
